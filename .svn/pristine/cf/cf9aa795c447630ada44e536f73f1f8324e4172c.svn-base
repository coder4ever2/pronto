...
<html>
	...
	<body style="width:500px">
		...
		<div id="create-alexaUser" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:alexaUserInstance, action:'verify']" >
				<fieldset class="form">
					
					<div class="fieldcontain ${hasErrors(bean: alexaUserInstance, field: 'verificationCode', 'error')} ">
						Phone: <g:textField name="phone" value="${alexaUserInstance?.phone}"/> 
						<br>
						Verification Code: <g:textField name="verificationCode" value="${alexaUserInstance?.verificationCode}"/> 
