...
<head>
    ...
    <link rel="stylesheet" href="<g:resource dir="css" file="style.min.css" absolute="true"/>">
    <link rel="stylesheet" href="<g:resource dir="css" file="hover.css" absolute="true"/>">

    <!--AMP config start-->
    <link rel="canonical" href="${createLink(uri: '/', absolute: true)}/b?name=${business.name}"/>
    ...
    <script type="text/javascript"
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB7jnM-YxeVmcrHtbIno1AHsJ3gqR8dKpw&libraries=places"></script>
    <script>
...
<header class="o-header">
    <nav class="o-header-nav">
        <g:link action="search" class="o-header-nav__link"><i class="fa fa-arrow-left"></i> Search</g:link>
    ...
    <div class="o-container">
        ...
        <div class="o-address">
            <img style="width:300px;height:300px;align:middle; margin:1em;" src="${business.photoReferenceURL}"/>
            	<!--<div>
	    		<g:form controller="b" action="claimBusinesses">
			        <label for="a">Enter the verification code</label><g:textField name="a"/><br/>
        ...
        <div class="o-address" style="text-align:center">
            ...
            <a class="hvr-bounce-to-right" onClick="showUserInfoDiv();"><i
                    class="fa fa-phone-square green button"></i> Connect</a>
            <!-- |
            ...
            <div id="userInfoDiv" class="userInfo" style="opacity:0.0;">
                ...
                <div id="callBackNumberDiv" class="input-group margin-bottom-sm" style="display: inline;">
                    ...
                    <input id="numberInput" name="numberInput" class="form-control" type="text"
                           placeholder="Call back number">
                    <g:field id="phoneHiddenInput" name="numberInput" class="form-control" type="hidden"
                ...
                <i id="checkSquareI" class="fa fa-check-square hvr-grow" aria-hidden="true"
                   onClick="onClickCheckMark()"></i>
